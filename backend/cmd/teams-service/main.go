...
import (
	...
	"github.com/gilleryugent/mimi-backend/services/teams"
	"github.com/gorilla/mux"
	"github.com/rs/cors"
)

func main() {
	cfg, err := config.Load("teams-service")
	if err != nil {
		panic(err)
	}
	...
	if err := db.Migrate(ctx, pool, "/migrations/teams"); err != nil {
	...
	go func() {
		logger.Info("teams-service listening", "port", cfg.Port)
