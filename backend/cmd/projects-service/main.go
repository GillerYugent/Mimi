...
import (
	...
	"github.com/gilleryugent/mimi-backend/services/projects"
	"github.com/gorilla/mux"
	"github.com/rs/cors"
)

func main() {
	cfg, err := config.Load("projects-service")
	if err != nil {
		panic(err)
	}
	...
	if err := db.Migrate(ctx, pool, "/migrations/projects"); err != nil {
	...
	go func() {
		logger.Info("projects-service listening", "port", cfg.Port)
